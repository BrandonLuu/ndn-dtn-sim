...
int main(int argc, char* argv[]) {
	...
	//ndn::L3RateTracer::InstallAll("trace/dtn-rate-trace.txt", Seconds(0.5));
	//nodes.Get(0)->TraceConnectWithoutContext ("WindowTrace", MakeCallback (&WindowChange));
